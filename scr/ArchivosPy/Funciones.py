...
# ------------------------------
usuario_sesion = None  # Usuario actualmente logueado
...
# ==========================================================
# LOGIN (modificado para guardar usuario en sesión)
# ==========================================================
def comprobar_login(line):
    ...
    if hash_password(password) == password_guardada:
        print(f"Login correcto! Usuario: {user_id}")
        usuario_sesion = user_id  # GUARDAR usuario que inició sesión
        return True
    else:
        print("Contraseña incorrecta")
        return False
...
# ==========================================================
# DEVOLVER USUARIO DE SESIÓN
# ==========================================================
def obtener_usuario_sesion():
    """Devuelve el usuario que inició sesión o cadena vacía si no hay sesión."""
    global usuario_sesion
    if usuario_sesion:
